...
double makedelta(vector<Point> points,int n_color){
    double min_dist[n_color+1];/// min_dist[i] is the shortest distance of one point from other point with different color,
    ...
    Point P_2;
    ///
    double max_dist_point;///every time after filling the list "min_dist" ,
